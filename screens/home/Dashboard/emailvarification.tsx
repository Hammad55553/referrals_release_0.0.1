...
const EmailVerification = () => {
  ...
  const handleSendOtp = () => {
    if (firebaseIDToken) {
      dispatch(sendOtp({email, type, token: firebaseIDToken}));
    }
  };
    ...
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        ...
        <Text style={styles.description}>
          Enter your work email address to receive a{' '}
          <Text style={styles.boldText}>One-Time password</Text> for
          verification.
        </Text>
        <View style={styles.inputView}>
          <Text style={styles.emailText}>Email your work email address</Text>
          <TextInput
            style={styles.input}
