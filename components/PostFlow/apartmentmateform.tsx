...
export const ApartmentMateForm: React.FC<ApartmentFormProps> = ({category}) => {
  ...
  const handleFormSubmitAppartmentmate = () => {
    let valid = true;
    if (validateForm()) {
  ...
  <TouchableOpacity
    ...
    />
      ...
      <PostButton onPress={handleFormSubmitAppartmentmate} label={'Post'} />
    </View>
  );
};
