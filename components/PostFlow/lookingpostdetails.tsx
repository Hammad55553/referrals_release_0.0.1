...
const LookingPostDetails = ({route}) => {
  ...
  function handleSlideComplete() {
    // logic here
    console.log('swiped looking post request');
    if (firebaseIDToken) {
        ...
        <View style={styles.container}>
          <View style={styles.content}>
            ...
            <View style={styles.footer}>
              ...
              <View style={styles.footerViewBottom}>
                <Text style={styles.footerText}>Price :</Text>
                <Text style={styles.footerTextBlue}>
                  $
                  {post.priceTo && post.priceTo.$numberDecimal
          ...
          <View style={styles.iconBox}>
            <TouchableOpacity style={styles.button}>
              <Text style={styles.buttonText}>Sublease</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.button}>
              <Text style={styles.buttonText}>Looking</Text>
            </TouchableOpacity>
          </View>
        </View>
...
export default LookingPostDetails;
