...
const QuickMessage = () => {
  ...
  const fetchQuickMessages = async () => {
    try {
      ...
      const response = await axios.get(`${BACKEND_DEV_URL}users/quickmessages`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
      const data = response.data.data.reduce((acc: QuickMessageData, message: any) => {
        if (message.category === 'Looking') acc.looking = message.message;
        if (message.category === 'Offering') acc.offering = message.message;
        if (message.category === 'Apartment Mate') acc.apartmentMates = message.message;
        return acc;
      }, { looking: '', offering: '', apartmentMates: '' });
      setMessageData(data);
    } catch (error) {
      console.error('Error fetching quick messages:', error.response || error.message || error);
    }
  };
      ...
      <View style={styles.container}>
        ...
        <View style={styles.messageContainer}>
          ...
          <Text style={styles.messageDescription}>
            This is a pre-written message sent when you are looking for a sublease or rental accommodation.
          </Text>
          <Text style={styles.smallText}>This message will be sent to users when you right-swipe on posts</Text>
          <View style={styles.nestedContainer}>
            <Text style={styles.lightText}>{messageData.looking}</Text>
            <TouchableOpacity
              style={styles.editIconContainer}
              onPress={() => navigation.navigate('Screens/Dashboard/EditLookingQuickMessage')}
            >
              <Image
        ...
        <View style={styles.messageContainer}>
          ...
          <Text style={styles.messageDescription}>
            This is a pre-written message sent when you are Offering a sublease or rental accommodation.
          </Text>
          <Text style={styles.smallText}>This message will be sent to users when you right-swipe on posts</Text>
          <View style={styles.nestedContainer}>
            ...
            <TouchableOpacity
              style={styles.editIconContainer}
              onPress={() => navigation.navigate('Screens/Dashboard/EditOfferingQuickMessage')}
            >
              <Image
                source={require('../../assets/icons/edit.png')}
                style={styles.editIcon}
        ...
        <View style={styles.messageContainer}>
          ...
          <Text style={styles.messageDescription}>
            This is a pre-written message sent when you are looking for apartment mates.
          </Text>
          <Text style={styles.smallText}>This message will be sent to users when you right-swipe on posts.</Text>
          <View style={styles.nestedContainer}>
            ...
            <TouchableOpacity
              style={styles.editIconContainer}
              onPress={() => navigation.navigate('Screens/Dashboard/EditAMQuickMessage')}
            >
              <Image
                source={require('../../assets/icons/edit.png')}
                style={styles.editIcon}
